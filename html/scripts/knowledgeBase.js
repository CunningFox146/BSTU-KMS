const KNOWLEDGE_BASE =
	[
		...
		["Иоганн Себастьян Бах", "- это", "автор более 1000 музыкальных произведений во всех значимых жанрах своего времени (кроме оперы)."],
		["Иоганн Себастьян", "- это", "автор более 1000 музыкальных произведений во всех значимых жанрах своего времени (кроме оперы)."],
		["Себастьян Бах", "- это", "автор более 1000 музыкальных произведений во всех значимых жанрах своего времени (кроме оперы)."],
		["Бах", "- это", "автор более 1000 музыкальных произведений во всех значимых жанрах своего времени (кроме оперы)."],
		["Дж. Хокинс", "- это", "создатель пианино"],
		["Гвидо", "- это", "создатель нот и сольфеджио"],
		["Макар", "- это", "автор курсового проекта"],
		["Дежемесов", "- это", "автор курсового проекта"],
		["Дежемесов Макар", "- это", "автор курсового проекта"],
		["Макар Сергеевич", "- это", "автор курсового проекта"],
		["Дежемесов Макар Сергеевич", "- это", "автор курсового проекта"],
		["Гурин", "- это", "Преподователь БГТУ. Доцент кафедры, к.ф.-м.н."],
		["Гурин Николай", "- это", "Преподователь БГТУ. Доцент кафедры, к.ф.-м.н."],
		["Николай Иванович", "- это", "Преподователь БГТУ. Доцент кафедры, к.ф.-м.н."],
