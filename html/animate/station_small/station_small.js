...
// stage content:
(lib.station_small = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.text.setTransform(511,1,0.5,0.5);
	...
	this.Pointer_11.setTransform(158.45,137.7,0.5,0.5,0,0,0,193.9,89.9);

	this.Pointer_12 = new lib.Pointer12();
	this.Pointer_12.name = "Pointer_12";
	this.Pointer_12.setTransform(158.55,122.5,0.5,0.5,0,0,0,193.6,154.6);

	this.Pointer_13 = new lib.Pointer13();
	this.Pointer_13.name = "Pointer_13";
	this.Pointer_13.setTransform(158.1,199.75,0.5,0.5,0,0,0,194.5,34.3);

	this.Pointer_2 = new lib.Pointer2();
	this.Pointer_2.name = "Pointer_2";
	this.Pointer_2.setTransform(158.4,83.6,0.5,0.5,0,0,0,193.9,106.8);

	this.Pointer_5 = new lib.Pointer5();
	this.Pointer_5.name = "Pointer_5";
	this.Pointer_5.setTransform(229.5,131.85,0.5,0.5,0,0,0,51.8,101.6);

	this.Pointer_10 = new lib.Pointer10();
	this.Pointer_10.name = "Pointer_10";
	this.Pointer_10.setTransform(229.5,167.15,0.5,0.5,0,0,0,51.8,2.7);

	this.Pointer_9 = new lib.Pointer9();
	this.Pointer_9.name = "Pointer_9";
	this.Pointer_9.setTransform(229.8,149.55,0.5,0.5,0,0,0,51.8,4.6);

	this.Pointer_7 = new lib.Pointer7();
	this.Pointer_7.name = "Pointer_7";
	this.Pointer_7.setTransform(229.65,126.8,0.5,0.5,0,0,0,51.5,23.7);

	this.Pointer_6 = new lib.Pointer6();
	this.Pointer_6.name = "Pointer_6";
	this.Pointer_6.setTransform(229.65,110.8,0.5,0.5,0,0,0,51.5,25.6);

	this.Pointer_4 = new lib.Pointer4();
	this.Pointer_4.name = "Pointer_4";
	this.Pointer_4.setTransform(229.65,39.85,0.5,0.5,0,0,0,51.5,53.2);

	this.Pointer_1 = new lib.Pointer1();
	this.Pointer_1.name = "Pointer_1";
	this.Pointer_1.setTransform(229.5,108.85,0.5,0.5,0,0,0,51.8,191.2);

	this.Pointer_3 = new lib.Pointer();
	this.Pointer_3.name = "Pointer_3";
	this.Pointer_3.setTransform(229.65,77.65,0.5,0.5,0,0,0,51.5,61);
	...
	this.Pointer_8.setTransform(158.45,120.85,0.5,0.5,0,0,0,193.9,22.1);

	this.Hover_12 = new lib.hover();
	this.Hover_12.name = "Hover_12";
	this.Hover_12.setTransform(61.8,45.25,0.5,0.5,0,0,0,0.1,0.1);

	this.Hover_11 = new lib.hover();
	this.Hover_11.name = "Hover_11";
	this.Hover_11.setTransform(61.5,92.75,0.5,0.5);

	this.Hover_8 = new lib.hover();
	this.Hover_8.name = "Hover_8";
	this.Hover_8.setTransform(61.5,109.8,0.5,0.5);

	this.Hover_2 = new lib.hover();
	this.Hover_2.name = "Hover_2";
	this.Hover_2.setTransform(61.45,136.95,0.5,0.5);

	this.Hover_13 = new lib.hover();
	this.Hover_13.name = "Hover_13";
	this.Hover_13.setTransform(60.85,182.65,0.5,0.5,0,0,0,0,0.1);

	this.Hover_1 = new lib.hover();
	this.Hover_1.name = "Hover_1";
	this.Hover_1.setTransform(203.6,204.5,0.5,0.5,0,0,0,0,0.1);

	this.Hover_5 = new lib.hover();
	this.Hover_5.name = "Hover_5";
	this.Hover_5.setTransform(203.6,182.65,0.5,0.5,0,0,0,0,0.1);

	this.Hover_10 = new lib.hover();
	this.Hover_10.name = "Hover_10";
	this.Hover_10.setTransform(203.6,168.55,0.5,0.5,0,0,0,0,0.1);

	this.Hover_9 = new lib.hover();
	this.Hover_9.name = "Hover_9";
	this.Hover_9.setTransform(203.6,153.45,0.5,0.5);

	this.Hover_7 = new lib.hover();
	this.Hover_7.name = "Hover_7";
	this.Hover_7.setTransform(203.95,138.65,0.5,0.5,0,0,0,0.1,0);

	this.Hover_6 = new lib.hover();
	this.Hover_6.name = "Hover_6";
	this.Hover_6.setTransform(203.95,123.6,0.5,0.5,0,0,0,0.1,0.1);

	this.Hover_3 = new lib.hover();
	this.Hover_3.name = "Hover_3";
	this.Hover_3.setTransform(203.95,108.2,0.5,0.5,0,0,0,0.1,0.1);

	this.Hover_4 = new lib.hover();
	this.Hover_4.name = "Hover_4";
	this.Hover_4.setTransform(203.95,10.95,0.5,0.5,0,0,0,0.1,0.1);
...
p.nominalBounds = new cjs.Rectangle(256,171,256,171);
// library properties:
lib.properties = {
